    ...
    <div class="p-10  text-white">
      <article class="text-pretty">
        ...
        <ul class="list-disc pt-4">
          ...
          <li>
            Tosa Personalizada: Seja uma tosa higiênica, estética ou uma preparação especial para competições, nosso
            time
            está
        ...
        <ul class="list-disc pt-4">
          ...
          <li>
            Ambiente Acolhedor: Criamos um ambiente seguro e confortável para que seu cãozinho se sinta à vontade
            durante
            todo
            o processo.
          </li>
